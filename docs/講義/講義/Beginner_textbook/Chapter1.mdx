...
<span class="gray_important">#include&lt;iostream&gt; </span>
<span class="gray_important">// 含括iostream函數庫</span>  
引入的函數庫，類似字典一般，讓每行指令知道它的功能  
<span class="gray_important">using namespace std; // 使用名稱空間：std</span> 

不想用的話需在每一次輸入、輸出等前加上std:: (p.s.真的很麻煩 真的)  
<span class="gray_important">int main( ) \{ &nbsp; &nbsp;\} // 程式主體</span>
主要程式碼的撰寫處  
#### 活動 1-1  
