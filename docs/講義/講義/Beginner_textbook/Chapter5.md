...
### 宣告
    ...
    ![](/img/Beginner_textbook_pic/image27.png)  
    - 範例：`int num[8];`
        | num | 21342343 | 234566 | 7867890 | 879057457 | 3525235 |235252  | 325235 | 23523525 |
        | :---: | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |  
        |  | num\[0\] | num\[1\] | num\[2\] | num\[3\] | num\[4\] | num\[5\] | num\[6\] | num\[7\] |

    - 範例：`int num[8] = {0, 1, 2, 3, 4, 5, 6, 7};`
        | num | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
        | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
        |  | num\[0\] | num\[1\] | num\[2\] | num\[3\] | num\[4\] | num\[5\] | num\[6\] | num\[7\] |


    ![](/img/Beginner_textbook_pic/image29.png)  
    | num\[8\] | 0 | 1 | 2 | 3 | 4 | **<h3>9</h3>** | 6 | 7 |
    | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
    |  | num\[0\] | num\[1\] | num\[2\] | num\[3\] | num\[4\] | num\[5\] | num\[6\] | num\[7\] |  
...
### **宣告**：  
    ![](/img/Beginner_textbook_pic/image8.png)  
    ...
    ![](/img/Beginner_textbook_pic/image23.png)  
    ...
    ![](/img/Beginner_textbook_pic/image21.png)  
    ...
    | 第0列 | num\[0\]\[\] | 0 | 1 | 2 | 3 | 4 |
    | 第1列 | num\[1\]\[\] | 5 | 6 | 7 | 8 | 9 |
    | 第2列 | num\[2\]\[\] | 10 | 11 | 12 | **<h3>9</h3>** | 14 |

### 常用範例：  
    ![](/img/Beginner_textbook_pic/image19.png)  
    ![](/img/Beginner_textbook_pic/image20.png)  
## 5-4 多維陣列  
...
2. 使用cin.getline(),來輸入字元陣列:
    ...
    ```
### **sizeof( )的用法**  
![](/img/Beginner_textbook_pic/image74.png)   
![](/img/Beginner_textbook_pic/image22.png)   
...
### 範例：
![](/img/Beginner_textbook_pic/image70.png)   
![](/img/Beginner_textbook_pic/image12.png)   
#### 程式碼重點
...
![](/img/Beginner_textbook_pic/image83.png)   
![](/img/Beginner_textbook_pic/image13.png)   
由這個例子我們可以看到使用cin、getline(cin,string)兩者之間的差別


我們想要在輸入字串之前先輸入一個數字，但卻在輸入數字之後直接執行了剩下的程式。 
![](/img/Beginner_textbook_pic/image82.png)  
...
![](/img/Beginner_textbook_pic/image80.png)  
![](/img/Beginner_textbook_pic/image16.png)  
![](/img/Beginner_textbook_pic/image49.png)  
![](/img/Beginner_textbook_pic/image63.png)  
![](/img/Beginner_textbook_pic/image68.png)  